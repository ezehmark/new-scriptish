    ...
    <>
      ...
      <div className="border-b border-border/30 bg-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-3xl font-bold text-accent">Analytics & Insights</h1>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-primary/10 border border-border/30 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Referral Analytics</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="p-4 bg-background/50 rounded-xl border border-border/20">
              ...
              <p className="text-sm text-foreground/75">View historical data and forecasts</p>
            </div>
            <div className="p-4 bg-background/50 rounded-xl border border-border/20">
              <h3 className="font-semibold text-accent mb-2">Clinic Performance</h3>
              <p className="text-sm text-foreground/75">Compare clinics by acceptance rate and TAT</p>
            </div>
            <div className="p-4 bg-background/50 rounded-xl border border-border/20">
              <h3 className="font-semibold text-accent mb-2">Impact Metrics</h3>
              <p className="text-sm text-foreground/75">Track patient outcomes and satisfaction</p>
            </div>
          </div>
        </div>
      </div>
